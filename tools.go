...
// UploadedOneFile is just a convenience method that calls UploadFiles, but expects only one file to
// be in the upload.
...
// and potentially an error. If the optional last parameter is set to true, then we wil not rename
...
func (t *Tools) UploadFiles(r *http.Request, uploadDir string, rename ...bool) ([]*UploadedFile, error) {
	...
	if err != nil {
		return nil, errors.New("the uploaded file is to ")
	}
